...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "en": {
        ...
        "group_not_found": "❌ Group not found: `{link}`\n\nPossible reasons:\n1. Group username is incorrect\n2. Group does not exist or has been deleted\n3. Group does not have a public username\n\n💡 Please try:\n• Check if the group username is correct\n• Use group ID (number)\n• Ensure the group has a public username",
